...
export DYLD_FALLBACK_LIBRARY_PATH="/Cellar/subversion/1.9.3/lib/libsvn_client-1.0.dylib:$DS_CLI/platform/mac/homebrew/lib:/Applications/XAMPP/xamppfiles/lib:/usr/lib"

...
# build directory.
TCL_BUILD_LIB_SPEC='-L/opt/local/var/macports/sources/rsync.macports.org/release/tarballs/base/vendor/tcl8.5.15/unix -ltcl8.5'
...
# compiled.
TCL_SRC_DIR='/opt/local/var/macports/sources/rsync.macports.org/release/tarballs/base/vendor/tcl8.5.15'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/opt/local/var/macports/sources/rsync.macports.org/release/tarballs/base/vendor/tcl8.5.15/unix -ltclstub8.5'
...
TCL_BUILD_STUB_LIB_PATH='/opt/local/var/macports/sources/rsync.macports.org/release/tarballs/base/vendor/tcl8.5.15/unix/libtclstub8.5.a'

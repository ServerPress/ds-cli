...
"cygwin-thread-multi-64int-1.7.35(0.28653)" or
	die "Errno architecture (cygwin-thread-multi-64int-1.7.35(0.28653)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";

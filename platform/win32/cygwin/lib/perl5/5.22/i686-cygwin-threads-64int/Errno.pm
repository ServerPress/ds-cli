...
"cygwin-thread-multi-64int-2.4.0(0.29253)" or
	die "Errno architecture (cygwin-thread-multi-64int-2.4.0(0.29253)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
